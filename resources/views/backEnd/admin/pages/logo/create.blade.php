        	...
        	<div class="col-md-12">
        		<div class="card">
		          	<div class="card-header">
		          		<h1 class="card-title">{{ (@$editData)?"Edit User":"Add LOgo" }}</h1>
		          		<a href="{{ Route('logo.manage')}}" class="btn btn-primary float-sm-right">
		          			Manage Logo <i class="fa fa-plus-circle"></i>
		          		</a>
		          	</div>
		          	<div class="card-body">
                        ...
                        @endif
		          		<form method="POST" action="{{ (@$editData)? route('logo.update', @$editData->id):route('logo.store') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Logo Name') }}</label>
