                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form method="POST" action="{{ route('aboutSection.update', $aboutSection->id) }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <textarea name="desc" id="desc" rows="5" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            @php $array = explode('<>',$aboutSection->list)@endphp
                                ...
                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                            <textarea name="final_text" id="final_text"  class="form-control">
